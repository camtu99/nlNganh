                                    ...
                                    <div class="khung-review">
                                        <div style="display: flex">
                                            ...
                                            @if(Session::get('id_tk'))
                                                @if (Session::get('tk_admin') || Session::get('id_tk') == $item->id)                                          
                                                <a style=" margin-left: auto;color:#eb7b07;;" href="/review/xoa/{{$item->id_review }}"><i class="fas fa-minus-circle"></i></a>                                               
                                               @endif
                                            @endif
                                        </div>                                   
                                        <div>
