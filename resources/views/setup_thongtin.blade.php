        ...
        <div style="    display: flex; padding: 30px;">
            <div>
                <div>
                    ...
                    @endif
                    <p type="button" style="text-align: center;font-weight: 500;border: solid 2px #b3d7ff;background-color: #dee2e6;" data-toggle="modal" data-target="#suadoi">Thay đổi hình ảnh</p>
                </div>
            </div>
            <div style="width:100%">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h6 class="modal-title">Thay đổi hình ảnh</h6>
                ...
                <div class="modal-body">
                  <div style="padding:10px 0;">
                      ...
                      <form action="/setup/anh/" method="post" style="width:100%;">
                          @csrf
                          <input  style="width:100%;" type="url" name="urlanh" id="">
